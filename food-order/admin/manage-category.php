...
<div class="main-content">
    <div class="wrapper">
        ...
        <a href="<?php echo SITEURL; ?>admin/history-category.php" class="btn btn-primary">Update Category Log</a>
        <br /><br /><br />
        ...
        <table class="tbl-full">
            ...
            <?php
                ...
                $sn = 1; // Create serial number variable and assign the value as 1
